...
var naviHTMLDict = {
	intro : '<h2 style="clear:left;"><a class="link" onclick="setup();populate(game);updateWLD();"><i class="fa fa-check-circle" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;I&#39;m Game!</a></h2><h2 style="clear:left"><a class="link" onclick="populate(about)"><i class="fa fa-arrow-circle-right"></i>&nbsp;&nbsp;&nbsp;&nbsp;Skip to About V</a></h2>',
